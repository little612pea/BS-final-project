  ...
  <el-scrollbar height="100%" style="width: 100%;">
    ...
    <div style="display: flex; flex-direction: column; width: 100%;">
      ...
      >
        ...
        <!-- 价格部分 -->
        <div style="width: 250px; text-align: left; display: flex; flex-direction: column; justify-content: center;">
          <!-- 旧价格 -->
          <p style="font-size: 20px; font-weight: normal; color: #888; margin: 0;">
            旧价格：
      ...
      ￥{{ product.price }}
          ...
          <!-- 新价格 -->
          <p style="font-size: 20px; font-weight: bold; color: #ec4a18; margin-top: 5px;">
            新价格：
            <span v-if="this.priceUpdates">{{ this.priceUpdates[product.id] }}</span>
            <span v-else style="color: #f39c12;">？</span>
          </p>
        </div>
        <div style="display: flex; flex-direction: column; margin-left: 10px; justify-content: center; align-items: flex-end;">
          <!-- 删除按钮 -->
          <el-button
              @click.stop="product.favorite = 0; products = products.filter(p => p.favorite !== 0);"
              icon="Delete"
              @click="toggleFavorite(product)"
              style="background-color: #e8b9b5; color: white; border: none; border-radius: 5px; padding: 5px 10px; cursor: pointer; width: 150px;">
            取消收藏商品
          </el-button>
          ...
          <el-button
              ...
              icon="UploadFilled"
              style="background-color: #fa8035; color: white; border: none; border-radius: 5px; padding: 5px 10px; cursor: pointer; margin-top: 5px; width: 150px;">
            爬取最新价格
          </el-button>
        </div>
      </div>
